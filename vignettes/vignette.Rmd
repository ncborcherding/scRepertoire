...
*facet.x and facet.y*
+  Any variable within the combined() object

*fill*
+  Color the bars by variable
...
## Clustering Clonotypes (in dev version only)
...
We can also look at count of cells by cluster assigned into specific frequency ranges, by using the *occupiedscRepertoire()* function and selecting the **x.axis** to display cluster or other variables in the meta data of the single cell object. 
