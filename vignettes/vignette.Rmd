...
```{r}
screp_example <- combineExpression(combined, screp_example, cloneCall="gene", groupBy = "sample", proportion = FALSE, cloneTypes=c(None=0, Single=1, Small=5, Medium=20, Large=100, Hyperexpanded=500))
