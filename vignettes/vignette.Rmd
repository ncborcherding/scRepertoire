...
combined <- addVariable(combined, 
                      name = "batch", 
                      variables = c("b1", "b1", "b1", "b2", "b2", "b2", "b2", "b2"))
...
The other option here is to be able to define the visualization by data classes. Here we used the *combineTCR()* to define the **batch** variable as part of the naming structure. We can the **group.by** to specifically use a column in the data set to organize the visualization.
