...
```{r}
combined <- addVariable(combined.TCR, 
                      name = "Type", 
                      variables = rep(c("B", "L"), 4))

combined[[1]][1:5,ncol(combined.TCR[[1]])] # This is showing the first 5 values of the new column added
```
...
After assigning the cloneby barcode, we can export the paired clonotypes using `exportClones()` to save for later use or to use in other pipelines. 
