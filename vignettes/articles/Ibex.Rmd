---
title: "Using Ibex for BCRs"
date: 'Compiled: `r format(Sys.Date(), "%B %d, %Y")`'
output: rmarkdown::html_vignette
theme: united
df_print: kable
vignette: >
  %\VignetteIndexEntry{Using Ibex for BCRs}
...
More infromation is available at the [Ibex GitHub Repo](https://github.com/ncborcherding/Ibex).
