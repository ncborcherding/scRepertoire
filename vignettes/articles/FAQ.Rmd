...
As scRepertoire returns a ggplot object, changing the general appearance of the plot itself is similar to the above, adding a gglayer with the desired theme.
