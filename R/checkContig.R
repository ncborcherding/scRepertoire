...
#'
#' This function quantifies the percent of NA values in either the 
#' sequence information of the VDJC gene usage. If a data frame 
#' output for the raw numbers and percentage of NAs are preferred, 
